...
namespace FitnessTrackerAPI.Models
{
    public class Client
    {
        ...
        public Guid? TemporaryCoachId { get; set; } // Temporary replacement
        public DateTime? TemporaryCoachStartDate { get; set; }
        public DateTime? TemporaryCoachEndDate { get; set; }
