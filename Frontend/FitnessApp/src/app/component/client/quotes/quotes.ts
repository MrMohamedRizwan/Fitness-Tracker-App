...
export class Quotes implements OnInit {
  motivationalQuotes: string[] = [
    ...
    'No pain, no gain. Wake up and train.',
    ...
    'Wake up. Work out. Be the improved version of yourself',
    ...
    'Make your body the stylish outfit you own.',
  ...
  ngOnInit(): void {
    ...
    if (storedQuote) {
      this.selectedQuote = storedQuote;
    } else {
      const randomIndex = Math.floor(Math.random() * this.motivationalQuotes.length);
      this.selectedQuote = this.motivationalQuotes[randomIndex];
      localStorage.setItem('selectedQuote', this.selectedQuote);
    }
  }
}
